...
# Charge les variables depuis le fichier .env local (ignoré par git).
# En prod (cPanel), les variables sont fournies par l'environnement ; si aucun
# .env n'est présent, load_dotenv ne fait rien et n'écrase jamais l'existant.
